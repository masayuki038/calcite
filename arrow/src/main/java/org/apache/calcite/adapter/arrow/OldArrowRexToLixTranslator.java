...
/**
 * .OldArrowRexToLixTranslator
 */
public class OldArrowRexToLixTranslator extends RexToLixTranslator {

    private RexProgram program;
    private Expression root;
    private RexBuilder builder;

    private OldArrowRexToLixTranslator(RexProgram program, JavaTypeFactory typeFactory, Expression root, InputGetter inputGetter, BlockBuilder list) {
    ...
    public OldArrowRexToLixTranslator(RexProgram program, JavaTypeFactory typeFactory, Expression root, InputGetter inputGetter, BlockBuilder list, Map<RexNode, Boolean> rexNodeBooleanMap, RexBuilder builder, OldArrowRexToLixTranslator oldArrowRexToLixTranslator, Function1<String, InputGetter> correlates) {
        super(program, typeFactory, root, inputGetter, list);
    }
    ...
    public static Expression translateCondition(
        ...
        OldArrowRexToLixTranslator translator =
                new OldArrowRexToLixTranslator(program, typeFactory, root, inputGetter, list);
    ...
    @Override
    public OldArrowRexToLixTranslator setCorrelates(
            Function1<String, InputGetter> correlates) {
        if (this.correlates == correlates) {
            return this;
        }
        return new OldArrowRexToLixTranslator(program, typeFactory, root, inputGetter, list,
